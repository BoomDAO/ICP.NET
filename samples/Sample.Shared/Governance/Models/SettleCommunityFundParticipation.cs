...
namespace Sample.Shared.Governance.Models
{
	...
	{
		[CandidName("result")]
		public OptionalValue<Result_7> Result { get; set; }

		[CandidName("open_sns_token_swap_proposal_id")]
		public OptionalValue<ulong> OpenSnsTokenSwapProposalId { get; set; }

		public SettleCommunityFundParticipation(OptionalValue<Result_7> result, OptionalValue<ulong> openSnsTokenSwapProposalId)
		{
			this.Result = result;
