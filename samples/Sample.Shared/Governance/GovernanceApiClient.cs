...
namespace Sample.Shared.Governance
{
	public class GovernanceApiClient
	{
		...
		public async Task<Models.Result_2> GetFullNeuron(ulong arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0));
		...
		public async Task<Models.Result_2> GetFullNeuronByIdOrSubaccount(Models.NeuronIdOrSubaccount arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0));
		...
		public async Task<Models.Result_3> GetMetrics()
		{
			CandidArg arg = CandidArg.FromCandid();
		...
		public async Task<Models.Result_4> GetMonthlyNodeProviderRewards()
		{
			CandidArg arg = CandidArg.FromCandid();
		...
		public async Task<Models.Result_5> GetNeuronInfo(ulong arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0));
		...
		public async Task<Models.Result_5> GetNeuronInfoByIdOrSubaccount(Models.NeuronIdOrSubaccount arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0));
		...
		public async Task<Models.Result_6> GetNodeProviderByCaller(NullValue arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0));
