...
namespace EdjCase.ICP.InternetIdentity
{
	public class InternetIdentityApiClient
	{
		...
		public async Task InitSalt(EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<Challenge> CreateChallenge(EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<RegisterResponse> Register(DeviceData arg0, ChallengeResult arg1, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task Add(UserNumber arg0, DeviceData arg1, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
			string method = "add";
			CandidTypedValue p0 = CandidTypedValue.FromObject(arg0);
			CandidTypedValue p1 = CandidTypedValue.FromObject(arg1);
		...
		public async Task Update(UserNumber arg0, DeviceKey arg1, DeviceData arg2, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task Remove(UserNumber arg0, DeviceKey arg1, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<System.Collections.Generic.List<DeviceData>> Lookup(UserNumber arg0, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<IdentityAnchorInfo> GetAnchorInfo(UserNumber arg0, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<EdjCase.ICP.Candid.Models.Principal> GetPrincipal(UserNumber arg0, FrontendHostname arg1, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<InternetIdentityStats> Stats(EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
			string method = "stats";
			var candidArgs = new List<CandidTypedValue>
			{
		...
		public async Task<Timestamp> EnterDeviceRegistrationMode(UserNumber arg0, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task ExitDeviceRegistrationMode(UserNumber arg0, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<AddTentativeDeviceResponse> AddTentativeDevice(UserNumber arg0, DeviceData arg1, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<VerifyTentativeDeviceResponse> VerifyTentativeDevice(UserNumber arg0, string verificationCode, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<(UserKey Arg0, Timestamp Arg1)> PrepareDelegation(UserNumber arg0, FrontendHostname arg1, SessionKey arg2, EdjCase.ICP.Candid.Models.OptionalValue<ulong> maxTimeToLive, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<GetDelegationResponse> GetDelegation(UserNumber arg0, FrontendHostname arg1, SessionKey arg2, Timestamp arg3, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<HttpResponse> HttpRequest(HttpRequest request, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<DeployArchiveResult> DeployArchive(System.Collections.Generic.List<byte> wasm, EdjCase.ICP.Agent.Identities.IIdentity? identityOverride = null)
		{
