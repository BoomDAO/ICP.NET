...
namespace EdjCase.ICP.InternetIdentity
{
	internal class InternetIdentityApiClient
	{
		...
		public async Task InitSalt(Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<Challenge> CreateChallenge(Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<RegisterResponse> Register(DeviceData arg0, ChallengeResult arg1, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task Add(UserNumber arg0, DeviceData arg1, Agent.Identities.IIdentity? identityOverride = null)
		{
			string method = "add";
			CandidTypedValue p0 = CandidTypedValue.FromObject(arg0);
			CandidTypedValue p1 = CandidTypedValue.FromObject(arg1);
		...
		public async Task Update(UserNumber arg0, DeviceKey arg1, DeviceData arg2, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task Remove(UserNumber arg0, DeviceKey arg1, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<List<DeviceData>> Lookup(UserNumber arg0, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<IdentityAnchorInfo> GetAnchorInfo(UserNumber arg0, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<Principal> GetPrincipal(UserNumber arg0, FrontendHostname arg1, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<InternetIdentityStats> Stats(Agent.Identities.IIdentity? identityOverride = null)
		{
			string method = "stats";
			var candidArgs = new List<CandidTypedValue>
			{
		...
		public async Task<Timestamp> EnterDeviceRegistrationMode(UserNumber arg0, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task ExitDeviceRegistrationMode(UserNumber arg0, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<AddTentativeDeviceResponse> AddTentativeDevice(UserNumber arg0, DeviceData arg1, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<VerifyTentativeDeviceResponse> VerifyTentativeDevice(UserNumber arg0, string verificationCode, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<(byte[] UserKey, Timestamp Expiration)> PrepareDelegation(UserNumber arg0, FrontendHostname arg1, SessionKey arg2, OptionalValue<ulong> maxTimeToLive, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<GetDelegationResponse> GetDelegation(UserNumber arg0, FrontendHostname arg1, SessionKey arg2, Timestamp arg3, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<HttpResponse> HttpRequest(HttpRequest request, Agent.Identities.IIdentity? identityOverride = null)
		{
		...
		public async Task<DeployArchiveResult> DeployArchive(PublicKey wasm, Agent.Identities.IIdentity? identityOverride = null)
		{
