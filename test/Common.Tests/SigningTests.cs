...
namespace ICP.Candid.Tests
{
	public class SigningTests
	{
		...
		public async Task Sign_QueryRequest()
		{
			...
			CandidArg arg = CandidArg.FromTypedValues(
			...
			var publicKey = DerEncodedPublicKey.FromEd25519(ByteUtil.FromHexString(publicKeyHex));
			...
			var delegation = new Delegation(publicKey.Value, delegationExpr);
